...
This is a CP/M-8000 BIOS derived from
[4sun5bu/Z8001MB](https://github.com/4sun5bu/Z8001MB) (MIT license),
modified to run on a machine with M20-like hardware (i8251 UART, IDE
disk, Z8530 SCC).
